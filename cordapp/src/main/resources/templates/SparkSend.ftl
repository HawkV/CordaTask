        ...
        <div class="main-content-container container-fluid text-center">
            <div class="page-header row no-gutters py-4 mb-3 text-center">
                <div class="col-12 text-center">
                    <h5 class="page-title align-items-center">Add some info</h5>
                </div>
            </div>
            <div class="row">
                                ...
                                <li class="list-group-item p-3">
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            <label>${x}</label>
                                            <input name="name" type="text" class="form-control" placeholder="Put your name" aria-label="Put your name" aria-describedby="basic-addon1">
                                        </div>
                                        <div class="form-group">
                                            <textarea name="desc" type="text" class="form-control" placeholder="Give some info about file" aria-label="Give some info about file" aria-describedby="basic-addon1"></textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                    ...
                                    <label class="text-muted d-block mb-2 text-center">${status[hashArray?seq_index_of(x)]}</label>
                                </li>
                            </#list>
                         </ul>
                    </div>
