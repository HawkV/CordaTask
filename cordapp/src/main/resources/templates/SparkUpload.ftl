        ...
        <div class="main-content-container container-fluid text-center">
            <div class="page-header row no-gutters py-4 mb-3 text-center">
                <div class="col-12 text-center">
                    <h5 class="page-title align-items-center">Uploader</h5>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="card card-small mb-4">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item p-3">
                                <strong class="text-muted d-block mb-2 text-center">Choose file</strong>
                                <label class="text-muted d-block mb-2 text-center">${status}</label>
                                <div class="row">
                                    <div class="col">
                                        <form method='post' enctype='multipart/form-data'>
                                            <label for="upload">
                                                <span class="mb-2 btn btn-outline-danger mr-2 btn-block btn-lg" aria-hidden="true">Choose</span>
                                                <input type="file" id=upload name="uploaded_file" style="display:none">
                                            </label>
                                            <button class="mb-2 btn btn-outline-danger mr-2 btn-lg" style="">Upload</button>
                                        </form>
                                    </div>
                                </div>
                            </li>
